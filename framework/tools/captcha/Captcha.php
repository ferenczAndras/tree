...
class Captcha
{
    ...
    private $sessionVariable = 'captcha';

    public function setSessionVariable($t)
    {
        $this->sessionVariable = $t;
    }
    ...
    public function init($config = array())
    {
        ...
        $this->code = $captcha_config['code'];

        $_SESSION[$this->sessionVariable] = $this->code;

    }

    public function randomGeneration($text_pos_x_min, $text_pos_x_max)
    {

        if ($text_pos_x_max < 0) {
            $text_pos_x_max = $text_pos_x_max * -1;
        }

        $r = mt_rand($text_pos_x_min, $text_pos_x_max);
        return $r;
    }
    ...
    public function render()
    {
        ...
        $text_pos_x = $this->randomGeneration($text_pos_x_min, $text_pos_x_max);
