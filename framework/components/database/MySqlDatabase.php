...
class MySqlDatabase
{
     ...
     *
     * @return MySqlDatabase Returns the current instance.
     */
    ...
    public function getOne($tableName, $columns = '*')
    {
        ...
        if ($res instanceof MySqlDatabase) {
            return $res;
     ...
     *                               or only $count
     *
     * @return bool Indicates success. 0 or 1. | null
     */
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert)
    {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof MySqlDatabase) {
     ...
     *
     * @return MySqlDatabase new mysqlidb object
     */
